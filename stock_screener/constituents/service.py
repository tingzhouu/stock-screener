...
from stock_screener.constituents.kospi200_wikipedia import get_kospi200_constituents
...
SUPPORTED_INDICES: tuple[str, ...] = ("SP500", "STI", "HSI", "CAC40", "NIKKEI225", "KOSPI200")
...
def get_index_constituents(index_code: str) -> List[Constituent]:
    ...
    if index_code == "KOSPI200":
        return get_kospi200_constituents()
